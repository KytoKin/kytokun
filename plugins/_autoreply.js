let fs = require('fs') 
 ...
     } 
      
     if (/@6283172999950$/i.test(m.text)) { 
 ...
        await this.setBio(`don't call and video call
I will immediately ban you
Runtime: ${uptime} | Mode: ${global.opts['self'] ? 'Private' : setting.groupOnly ? 'Only Group' : 'Public'} | Made Kyto Kin`).catch(_ => _)  
